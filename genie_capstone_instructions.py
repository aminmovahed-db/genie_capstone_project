...
# MAGIC - <a href="$./genie_capstone_sample_student_report">genie_capstone_sample_student_report</a> — Sample delivery report (scores per tuning step, Genie links, Discovery / Design / Tuning / Monitoring)
# MAGIC 
# MAGIC ## Objective
# MAGIC 
