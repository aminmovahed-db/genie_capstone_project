...
# MAGIC
# MAGIC Set the **Catalog** and **Schema** widgets at the top of the notebook, then **Run All** to:
# MAGIC 1. Execute every benchmark query against your tables
# MAGIC 2. Print copy-paste-ready SQL (with your catalog/schema substituted) for the Genie Space
# MAGIC
# MAGIC ---
...
# MAGIC
# MAGIC Each cell below runs the gold-standard SQL and displays results. The final cell prints all 15 queries in a format you can copy directly into your Genie Space.
...
# MAGIC
# MAGIC The cell above already ran each query. The cell below prints all 15 in a clean format you can copy directly into your Genie Space as example SQL.
